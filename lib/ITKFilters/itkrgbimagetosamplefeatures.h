#ifndef ITKRGBIMAGETOSAMPLEFEATURES_H
#define ITKRGBIMAGETOSAMPLEFEATURES_H
...
/** \class RGBImageToSampleFeatures
...
class ITK_EXPORT RGBImageToSampleFeatures :
public ProcessObject
{
public:
    /** Standard class typedefs */
    typedef RGBImageToSampleFeatures        Self;
    typedef ProcessObject               Superclass;
    typedef SmartPointer< Self >        Pointer;
    typedef SmartPointer<const Self>    ConstPointer;

    /** Run-time type information (and related methods). */
    itkTypeMacro(RGBImageToSampleFeatures, ProcessObject);
    ...
    * any meaningful output. */
    ...
    itkSetInputMacro(Input, ImageType)

    /** Get the "Position to compare with the object */
    itkGetInputMacro(Input, ImageType)
...
#include "itkrgbimagetosamplefeatures.txx"
#endif

#endif // ITKRGBIMAGETOSAMPLEFEATURES_H
